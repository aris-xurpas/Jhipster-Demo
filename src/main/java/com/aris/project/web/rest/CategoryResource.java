...
import com.aris.project.domain.Category;
import com.aris.project.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link com.aris.project.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CategoryResource {
    ...
    public ResponseEntity<List<Category>> getAllCategories(
        ...
        if ("item-is-null".equals(filter)) {
            log.debug("REST request to get all Categorys where item is null");
            return new ResponseEntity<>(
                StreamSupport
                    .stream(categoryRepository.findAll().spliterator(), false)
                    .filter(category -> category.getItem() == null)
