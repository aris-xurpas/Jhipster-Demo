...
export class DiscountService {
  ...
  update(discount: IDiscount): Observable<EntityResponseType> {
    return this.http.put<IDiscount>(`${this.resourceUrl}/${getDiscountIdentifier(discount) as number}`, discount, { observe: 'response' });
  }

  partialUpdate(discount: IDiscount): Observable<EntityResponseType> {
    return this.http.patch<IDiscount>(`${this.resourceUrl}/${getDiscountIdentifier(discount) as number}`, discount, {
      observe: 'response',
    });
  }
