...
import com.aris.project.domain.Customer;
import com.aris.project.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).contactNumber(DEFAULT_CONTACT_NUMBER);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).contactNumber(UPDATED_CONTACT_NUMBER);
        return customer;
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).contactNumber(UPDATED_CONTACT_NUMBER);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).contactNumber(UPDATED_CONTACT_NUMBER);
