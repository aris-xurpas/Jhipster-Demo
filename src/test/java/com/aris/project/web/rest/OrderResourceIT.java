...
import com.aris.project.domain.Order;
import com.aris.project.domain.enumeration.Status;
import com.aris.project.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().status(DEFAULT_STATUS).dateOrdered(DEFAULT_DATE_ORDERED);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().status(UPDATED_STATUS).dateOrdered(UPDATED_DATE_ORDERED);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getDateOrdered()).isEqualTo(DEFAULT_DATE_ORDERED);
    }
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.status(UPDATED_STATUS).dateOrdered(UPDATED_DATE_ORDERED);
        ...
        assertThat(testOrder.getDateOrdered()).isEqualTo(UPDATED_DATE_ORDERED);
    }
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.status(UPDATED_STATUS).dateOrdered(UPDATED_DATE_ORDERED);
